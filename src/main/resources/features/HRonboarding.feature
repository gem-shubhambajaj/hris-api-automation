...
##
#Scenario: HRIS, User is able to accept offer of the candidate
#    When Set endpoint and method and Description and payload "save" and "post" and "Save Candidate" and "acceptOffer" and "HRSaveDataApi"
#    Then Verify Status code 200
